...
from quickdkt.train.train_dktplus import dktplus
...
def run(args):
    ...
    # dataformat: tuple (q_array, pa_array, p_array)
    ...
    # log config
    logging.basicConfig(filename='training_dktplus_promblem.log', level=logging.INFO, 
    ...
    ktm = dktplus(model, loss_params, device)
...
if __name__ == "__main__":
    ...
    """
    Regularization items in dktplus
    lambda_r  = [0, 0.05, 0.1, 0.15, 0.20, 0.25]
    lambda_w1 = [0, 0.01, 0.03, 0.1, 0.3, 1.0]
    lambda_w2 = [0, 0.3, 1.0, 3.0, 10.0, 30.0, 100.0]
    """ 
    # model args
    ...
    parser.add_argument("--lambda_r", type=float, default=0.25)
    parser.add_argument("--lambda_w1", type=float, default=0.03)
    parser.add_argument("--lambda_w2", type=float, default=0.3)
